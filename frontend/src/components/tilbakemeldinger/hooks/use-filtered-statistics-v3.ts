...
import { useStatisticsVedtaksinstansleder } from '@app/simple-api-state/statistics/v3/use-statistics-vedtaksinstansleder';
...
export const useTilbakemeldingerStatisticsV3IsLoading = (): boolean => useStatistics().isLoading;

const EMPTY_ARRAY: IStatisticVurderingV3[] = [];
...
export const useFilteredStatisticsV3 = () => {
  ...
  const filter = useCallback(
    ({ sakstypeId, ytelseId, utfallId, hjemmelIdList, tilbakekreving }: IStatisticVurderingV3) =>
