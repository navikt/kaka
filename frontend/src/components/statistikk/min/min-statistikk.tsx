...
const V1Content = () => (
  <Content stats={useFilteredMyStatisticsV1()} version={V1} isLoading={useMyStatisticsV1IsLoading()} />
);
const V2Content = () => (
  <Content stats={useFilteredMyStatisticsV2()} version={V2} isLoading={useMyStatisticsV2IsLoading()} />
);
