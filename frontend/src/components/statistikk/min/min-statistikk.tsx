...
import { useFilteredMyStatistics, useMyStatisticsIsLoading } from './hooks/use-statistics';
...
export const MinStatistikk = () => {
  const stats = useFilteredMyStatistics();

  return (
    <>
      <LoadingOverlay isLoading={useMyStatisticsIsLoading()} />
