...
import { REASON_TO_SUBREASONS, SAKENS_DOKUMENTER_REASONS } from '@app/types/statistics/legacy/structures';
import { SAKENS_DOKUMENTER_TEXTS } from '@app/types/statistics/legacy/texts';
