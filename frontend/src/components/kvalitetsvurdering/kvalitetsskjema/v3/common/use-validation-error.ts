import type { GroupErrorField } from '@app/components/kvalitetsvurdering/kvalitetsskjema/v3/common/types';
...
type Field = keyof KvalitetsvurderingDataV3 | keyof ISaksdataIncomplete | GroupErrorField;
